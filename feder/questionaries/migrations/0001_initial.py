    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blob', jsonfield.fields.JSONField(verbose_name='Technical definition')),
            ],
            options={
                'ordering': ['position'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lock', models.BooleanField(default=False, help_text='Prevent of edit question to protect against destruction the data set', verbose_name='Lock of edition')),
