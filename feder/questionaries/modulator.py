...
class BaseModulator(object):
    ...
    def description(self):
        ...
        raise NotImplementedError(
            "Provide property 'description' in {name}".format(
    ...
    def list_create_question_fields(self):
        ...
        """
        raise NotImplementedError(
            "Provide method 'list_create_question_fields' in {name}".format(
                name=self.__class__.__name__
            )
        )
    ...
    def list_create_answer_fields(self, definition, survey=None):
        ...
        """
        raise NotImplementedError(
            "Provide method 'list_create_answer_fields' in {name}".format(
                name=self.__class__.__name__
            )
        )
    ...
    def get_label_text(self, definition):
        ...
        """
        raise NotImplementedError(
            "Provide method 'get_label_text' in {name}".format(
                name=self.__class__.__name__
            )
        )
    ...
    def get_answer_text(self, definition, content):
        ...
        """
        raise NotImplementedError(
            "Provide method 'get_answer_text' in {name}".format(
                name=self.__class__.__name__
            )
        )
    ...
    def get_label_column(self, definition):
        ...
        """
        raise NotImplementedError(
            "Provide method 'get_label_column' in {name}".format(
                name=self.__class__.__name__
            )
        )
    ...
    def get_answer_columns(self, definition, content):
        ...
        """
        raise NotImplementedError(
            "Provide method 'get_answer_columns' in {name}".format(
                name=self.__class__.__name__
            )
        )
...
class BaseSimpleModulator(BaseModulator):
    ...
    def list_create_question_fields(self):
        return (
            ("name", forms.CharField(label=_("Question"))),
            (
                "help_text",
                forms.CharField(label=_("Description of question"), required=False),
            ),
            (
                "required",
                forms.BooleanField(
                    label=_("This fields will be required?"), required=False
                ),
            ),
            ("comment", forms.BooleanField(label=_("Allow comment"), required=False)),
            (
                "comment_label",
                forms.CharField(label=_("Description of comment"), required=False),
            ),
            (
                "comment_help",
                forms.CharField(label=_("Help text of comment"), required=False),
            ),
            (
                "comment_required",
                forms.BooleanField(label=_("Are comment required?"), required=False),
            ),
        )
    ...
    def list_create_answer_fields(self, definition, survey=None):
        ...
        if definition.get("comment", True):
            commend_field = forms.CharField(
                label=definition.get("comment_label", ""),
...
class JSTModulator(BaseSimpleModulator):
    ...
    def list_create_question_fields(self):
        return (
            ...
            ("area", forms.ChoiceField(choices=self.CHOICES.items(), label=("Area"))),
            (
                "autocomplete",
                forms.BooleanField(label=_("Display as autocomplete?"), required=False),
            ),
        )
...
class LetterChoiceModulator(BaseSimpleModulator):
    ...
    output_fields_cls = forms.ModelChoiceField
    CHOICES = {"all": _("All"), "outgoing": _("Outgoing"), "incoming": _("Incoming")}
        ...
        return (
            ...
            (
                ...
                forms.ChoiceField(
                    ...
                    label=("Filter"),
                    help_text=_(
                        "Specifiy which letter " "user should be able to select"
                    ),
                ),
            ),
        )
    ...
    def list_create_answer_fields(self, definition, survey=None):
        ...
        if survey is None:
            ...
            kwargs["queryset"] = self.choice_map(
                survey.case.letter_set.all(), definition.get("filter", "all")
            )
        return (("value", forms.ModelChoiceField(**kwargs)),)
