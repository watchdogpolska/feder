...
from feder.tasks.factories import CharAnswerFactory, JSTAnswerFactory, SurveyFactory
...
class QuestionaryUpdateTestCase(ObjectMixin, PermissionStatusMixin, TestCase):
    ...
    def get_url(self):
        return reverse("questionaries:update", kwargs={"pk": self.questionary.pk})
...
class QuestionaryDeleteTestCase(ObjectMixin, PermissionStatusMixin, TestCase):
    ...
    def get_url(self):
        return reverse("questionaries:delete", kwargs={"pk": self.questionary.pk})
    ...
    def test_get_success_url(self):
        ...
        self.assertRedirects(response, self.questionary.monitoring.get_absolute_url())
...
class SurveyCSVViewTestCase(ObjectMixin, PermissionStatusMixin, TestCase):
    ...
    def get_url(self):
        return reverse("questionaries:export", kwargs={"pk": self.questionary.pk})
