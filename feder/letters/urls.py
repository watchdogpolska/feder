...
urlpatterns = [
    url(_(r"^$"), views.LetterListView.as_view(), name="list"),
    url(_(r"^feed$"), views.LetterRssFeed(), name="rss"),
    url(_(r"^feed/atom$"), views.LetterAtomFeed(), name="atom"),
    url(
    ...
    url(_(r"^feed/case-(?P<case_pk>[\d-]+)/$"), views.LetterCaseRssFeed(), name="rss"),
    url(
    ...
    url(_(r"^(?P<pk>[\d-]+)$"), views.LetterDetailView.as_view(), name="details"),
    url(_(r"^(?P<pk>[\d-]+)$"), views.LetterDetailView.as_view(), name="details"),
    url(
        _(r"^(?P<pk>[\d-]+)-msg$"),
    ...
    url(_(r"^(?P<pk>[\d-]+)/~send"), views.LetterSendView.as_view(), name="send"),
    url(
